...
class ar10:
    def __init__(self):
        ...
        self.intercept = [5353.70260525,8273.71048835,8165.38573286,8227.37128181,8088.11621425,8243.9311687,8103.72787146,8202.91181762,8176.91046716,8134.46292949]
        self.slope     = [4.16582114481,-6.74691539571,-6.10951234585,-6.38215266993,-5.84438764483,-6.50953923783,-5.81599332552,-6.21288586758,-6.1768841792,-5.87312912987]
...
#            for row in cal_file:
#                self.intercept = (float(row[1]))
#		print self.intercept
#                self.slope = (float(row[2]))
#        except IOError:
